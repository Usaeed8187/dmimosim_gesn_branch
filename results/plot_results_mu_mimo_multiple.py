    ...
    for ue_arr_idx in range(np.size(rx_ues_arr)):
        ...
        for drop_idx in np.arange(1, num_drops+1):
            ...
            if prediction_results:
                file_path = "results/channels_multiple_mu_mimo/results/channels_{}_{}/mu_mimo_results_UE_{}_pred.npz".format(curr_mobility, drop_idx, rx_ues_arr[ue_arr_idx])
            else:
                file_path = "results/channels_multiple_mu_mimo/results/channels_{}_{}/mu_mimo_results_UE_{}.npz".format(curr_mobility, drop_idx, rx_ues_arr[ue_arr_idx])
