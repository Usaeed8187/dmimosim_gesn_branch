...
from .slnr_precoding import mumimo_slnr_equalizer


class SLNREqualizer(Layer):
    """SLNR Equalizer for MU-MIMO"""
    ...
    def call(self, inputs):
        ...
        if len(inputs) == 5:
            ...
            y, h, no, ue_indices, ue_ranks = inputs
        ...
        # SLNR equalizing
        y_equalized = mumimo_slnr_equalizer(y_equalized, h_eq_desired, no, ue_indices)
