...
if __name__ == "__main__":
    ...
    cfg.num_tx_streams = 6      # 6/8/12 equal to total number of streams
    ...
    for sto in [10, 20]:
        for cfo in [100, 200, 300]:
            ...
            for k in range(num_modulations):
                ...
                plt.savefig("../results/mu_mimo_results_cfo{}_sto{}.png".format(cfo, sto))

                np.savez("../results/mu_mimo_results_cfo{}_sto{}.npz".format(cfo, sto),
