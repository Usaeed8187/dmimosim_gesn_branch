...
if __name__ == "__main__":
    ...
    cfg.ns3_folder = "../ns3/channels_s1/"
    ...
    for num_tx_streams in [2, 4]:
        ...
        plt.savefig("../results/baseline_results_s{}.png".format(cfg.num_tx_streams))

        np.savez("../results/baseline_results_s{}.npz".format(cfg.num_tx_streams),
